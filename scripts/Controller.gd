...
const MonsterEntity := preload("res://entities/Monster/Monster.tscn")
const LaserMonsterEntity := preload("res://entities/Monster/LaserMonster.tscn")
const FastMonsterEntity := preload("res://entities/Monster/FastMonster.tscn")
const ChargeMonsterEntity := preload("res://entities/Monster/ChargeMonster.tscn")
